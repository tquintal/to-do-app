...
function ToDoList() {
    ...
    const setSortByHandler = event => {
        context.setSortBy(event.target.id);
    };
    ...
    return <div className={classes['to-do-list-container']}>
        {
            context.groupBy !== 'deleted' ?
                <>
                    ...
                    </div>
                    {
                        ...
                        <ul className={classes['ul-container']}>
                            {context.displayToDos.map(todo => !todo.completed && (context.groupBy === 'deleted' ? todo.deleted : !todo.deleted) &&
                                <li key={todo.id}>
                ...
                <>
                    ...
                    <SearchToDo />
                    <ul className={classes['ul-container']}>
                        {console.log(context.displayToDos)}
                        {context.displayToDos.map(todo =>
                            <li key={todo.id}>
                                <div className={classes['todo-container']}>
                                    <input
                                        type='text'
